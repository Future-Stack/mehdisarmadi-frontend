    ...
    <div className="space-y-10 py-6 max-w-[1400px] mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {PROJECTS.map((project, idx) => (
          <div key={idx} className="bg-white border border-gray-50 rounded-[32px] p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col gap-6">
            ...
            <div className="space-y-3.5 pt-2">
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-400 font-bold">Processing:</span>
                <span className="px-3 py-1 bg-blue-100 text-blue-600 rounded-lg text-[11px] font-black uppercase tracking-wider">
                  {project.status.processing}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-400 font-bold">Analysis:</span>
            ...
            <div className="flex gap-3 pt-2">
              <Button 
                variant="secondary" 
                className="flex-1 h-12 rounded-2xl font-bold shadow-sm"
              >
                Open
              </Button>
              <Button 
