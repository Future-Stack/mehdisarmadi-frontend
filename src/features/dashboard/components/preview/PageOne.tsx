...
export const PageOne = ({ exportMode, quoteData }: { exportMode?: boolean; quoteData?: any }) => {
    ...
    <div className={exportMode ? "bg-white text-gray-900 font-sans " : "bg-white text-gray-900 shadow-xl border border-gray-200 mx-auto w-full max-w-[850px] min-h-[1100px]  flex flex-col font-sans"}>
        {exportMode ? (
            <div id="export-header" className="px-12 pt-12 pb-0">
        ...
        <div className={`mb-6 px-12 ${exportMode ? 'export-section' : ''}`}>
            ...
            <table className="w-full text-[11px] border-collapse border border-gray-200">
                <tbody className="divide-y divide-gray-100">
                    ...
                    <tr><td className="py-2 px-4 font-bold text-gray-500 bg-gray-50">Revision Number</td><td className="py-2 px-4 font-medium">{q.revisionNumber || "N/A"}</td></tr>
                    <tr><td className="py-2 px-4 font-bold text-gray-500 bg-gray-50">Bid Closing Date</td><td className="py-2 px-4 font-medium">{q.bidClosingDate || "N/A"}</td></tr>
                    <tr><td className="py-2 px-4 font-bold text-gray-500 bg-gray-50">Addenda Included</td><td className="py-2 px-4 font-medium">{q.addendaIncluded || "N/A"}</td></tr>
                    <tr><td className="py-2 px-4 font-bold text-gray-500 bg-gray-50">Subject</td><td className="py-2 px-4 font-medium">{q.subject || "N/A"}</td></tr>
                </tbody>
            </table>
        </div>
