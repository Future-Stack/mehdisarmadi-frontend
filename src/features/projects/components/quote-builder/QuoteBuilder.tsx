  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#ECFDF5] to-white ">
      ...
      <div className=" ">
        <div className="max-w-[1200px] mx-auto flex items-center justify-between">
          <div className="space-y-4">
            <button
              onClick={() => router.back()}
              className="flex items-center gap-2 text-xs font-black text-gray-900 hover:text-[#059669] transition-colors"
            >
      ...
      <div className="max-w-[1200px] mx-auto px-8 py-8 space-y-8">
        {/* AI Banner */}
        <div className="bg-[#FFF7ED] border border-[#FFEDD5] rounded-2xl p-6 flex items-start gap-4">
          <div className="bg-white p-2 rounded-lg shadow-sm">
            <AlertCircle className="w-5 h-5 text-[#F97316]" />
          </div>
          <div className="space-y-1">
            <h3 className="text-base font-black text-[#9A3412]">
              Draft Quote (AI-Generated) - For Estimator Review
            </h3>
            <p className="text-[#9A3412] text-sm font-medium opacity-80">
        ...
        {/* Company Information */}
        <section className="bg-white rounded-[32px] border border-gray-100 p-8 shadow-sm space-y-8">
        ...
        <section className="bg-white rounded-[32px] border border-gray-100 p-8 shadow-sm space-y-8">
          <div className="flex justify-between items-start">
            <div className="space-y-1">
              <h2 className="text-lg font-black text-[#1F2937]">Pricing</h2>
              <p className="text-gray-400 text-xs font-bold">
        ...
        >
          ...
          <button
            ...
            className="w-full py-3 bg-[#F0FDF4] border border-dashed border-[#059669]/20 rounded-xl text-[#059669] font-black text-[10px] uppercase tracking-wider flex items-center justify-center gap-2 hover:bg-[#DCFCE7] transition-all"
          >
        ...
        <section className="bg-[#F0FDF4] rounded-[32px] border border-[#059669]/10 p-8 shadow-sm flex flex-col gap-6">
          <div className="flex justify-between items-start">
            <div className="space-y-1">
              <h2 className="text-lg font-black text-[#065F46]">
                Advanced Alternative Builder
              </h2>
              <p className="text-emerald-600/60 text-xs font-bold">
                Use this builder for complex itemized alternatives
              </p>
            </div>
            <button
              onClick={handleOpenAltModal}
              className="bg-[#059669] text-white h-11 px-6 rounded-xl font-black text-xs flex items-center gap-2 shadow-lg shadow-emerald-100 hover:bg-[#047857] transition-all"
            >
          ...
          <div className="space-y-8 py-4">
            ...
            <div className="border border-gray-100 rounded-3xl overflow-hidden shadow-sm">
                    ...
                    <tr key={idx}>
                      ...
                      <td className="py-4 px-6 text-right">
                        <Input
                          value={row.total}
                          readOnly
                          className="h-10 text-xs rounded-xl border-gray-50 bg-gray-50 text-right font-black text-[#059669]"
                          onChange={() => {}}
                        />
                      </td>
                      <td className="py-4 px-6">
              ...
              <button
                ...
                className="w-full py-3 bg-[#F0FDF4]/50 text-[#059669] font-black text-[10px] uppercase tracking-wider flex items-center justify-center gap-2 hover:bg-[#F0FDF4] transition-all"
              >
            ...
            <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
              <button
                ...
                className="h-12 px-8 rounded-xl font-black text-xs text-gray-500 hover:bg-gray-50 transition-all"
              >
                Cancel
              </button>
              <button
                onClick={handleSaveModalItems}
                className="bg-[#059669] text-white h-12 px-8 rounded-xl font-black text-xs shadow-lg shadow-emerald-100 hover:bg-[#047857] transition-all"
              >
                Save Changes
              </button>
            </div>
            ...
            {editingSections["commercial"] ? (
              <>
                <div className="space-y-2">
                  ...
                  <textarea
                    className="w-full h-24 border border-gray-200 rounded-xl p-4 text-sm font-medium"
        ...
        {/* Footer Notes */}
        <section className="bg-white rounded-[32px] border border-gray-100 p-8 shadow-sm space-y-4">
          <h2 className="text-lg font-black text-[#1F2937]">Footer Notes</h2>
          <textarea
            value={formData.footerNotes}
            onChange={(e) => handleInputChange("footerNotes", e.target.value)}
            className="w-full h-32 bg-white border border-gray-100 rounded-2xl p-6 text-sm font-medium text-gray-500 focus:outline-none focus:ring-4 focus:ring-[#059669]/5 focus:border-[#059669] transition-all resize-none"
          />
        </section>
        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-4 gap-4">
          ...
          <button
            ...
            className="bg-[#059669] text-white h-14 rounded-2xl font-black text-sm flex items-center justify-center gap-3 shadow-xl shadow-emerald-100 hover:bg-[#047857] transition-all active:scale-95"
          >
            Save & Close
          </button>
        </div>
...
function InfoRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex gap-4 items-baseline">
      <span className="text-xs font-black text-gray-900 w-20">{label}</span>
  ...
  return (
    <div className="space-y-2">
      ...
      <Input
        value={value}
        readOnly
        className="h-12 bg-white border-gray-100 rounded-xl text-sm font-medium text-[#1F2937] focus:border-[#059669] focus:ring-0 transition-all px-6"
        onChange={() => {}}
      />
    </div>
  );
    ...
    <section className="bg-white rounded-[32px] border border-gray-100 p-8 shadow-sm space-y-8">
      <div className="flex justify-between items-start">
        <div className="space-y-1">
          ...
          <p className="text-gray-400 text-xs font-bold">{subtext}</p>
        </div>
        {onToggleEdit && (
          <button
      ...
      <div className="bg-[#F9FAFB] rounded-[24px] p-8 border border-gray-50">
        {children}
      </div>
    </section>
  );
  ...
  return (
    <section className="bg-white rounded-[32px] border border-gray-100 p-8 shadow-sm space-y-8">
      <div className="flex justify-between items-start">
        ...
        <div className="px-3 py-1 bg-[#F0FDF4] text-[#059669] rounded-lg text-[9px] font-black uppercase tracking-wider">
          {badge}
        </div>
      </div>
...
function ExportButton({
  ...
  return (
    <button
      onClick={onClick}
      className="bg-white border-2 border-[#059669]/20 text-[#059669] h-14 rounded-2xl font-black text-sm flex items-center justify-center gap-3 hover:bg-emerald-50 transition-all group active:scale-95 shadow-sm"
    >
