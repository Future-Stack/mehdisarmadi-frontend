...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-10 flex h-20 shrink-0 items-center justify-between border-b border-black/5 bg-primary/60 px-6 backdrop-blur-md dark:bg-primary/60">
      {/* Page Title or Breadcrumb Placeholder */}
      <div className="flex items-center gap-4">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-white">
          Overview
        </h2>
        <Badge variant="success" className="bg-secondary/10 text-secondary border-none">
          Live
        </Badge>
      </div>
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="hidden md:flex relative group">
          ...
          <input 
            ...
            className="h-10 w-64 rounded-full border border-gray-200 bg-gray-50 pl-10 pr-4 text-sm transition-all focus:border-secondary focus:bg-white focus:outline-none focus:ring-4 focus:ring-secondary/10 dark:border-white/5 dark:bg-white/5 dark:focus:bg-white/10"
          />
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span className="absolute right-2.5 top-2.5 h-2 w-2 rounded-full bg-secondary border-2 border-primary" />
          </button>
        </div>
